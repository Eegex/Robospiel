...
enum PlayerAction{none = 0x0,
                  ...
                  user = 0x1000, newUser = 0x1001, changedUsername = 0x1002, changedUserColor = 0x1004, userLeft=0x1008,changeActiveUser = 0x1010, changedTimerTime = 0x1100,resetPoints = 0x1200,
