...
enum PlayerAction{none = 0x0,
				  ...
				  other = 0x800, giveUp = 0x801, revert = 0x802, revertToBeginning = 0x804, freePlay = 0x808, skipTimer = 0x810, skipGoal = 0x820,
				  user = 0x1000, newUser = 0x1001, changedUsername = 0x1002, changedUserColor = 0x1004, userLeft = 0x1008, changeActiveUser = 0x1010,
				  update = 0x2000, completeUpdate = 0x2001, boardUpdate = 0x2002,
				  menuAction = 0x4000, editBoard = 0x4001, nextTarget = 0x4002, setIdle = 0x4003,
