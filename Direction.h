...
enum PlayerAction{none = 0x0,
				  ...
				  other = 0x800, giveUp = 0x801, revert = 0x802, revertToBeginning = 0x804, freePlay = 0x808, vote = 0x810, votekick = 0x820,
                  ...
                  intern = 0x8000, syncRandomGenerators = 0x8001, registerClient = 0x8002, switchServer= 0x8004, sendServerID= 0x8008
				 };
